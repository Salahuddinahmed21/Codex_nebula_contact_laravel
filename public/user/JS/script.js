...
form.addEventListener('submit', e => {
    ...
    if (validateForm()) {
        ...
        window.location.href = 'index2.html';  // Replace 'next_page.html' with the actual URL of the next page
    }
});
...
function validateField(field) {
    ...
    } else if (field === country && value.toLowerCase() === 'israel') {
        setError(field, 'Sorry, we cannot process requests from Israel');
    } else {
        setSuccess(field);
    }
}
